          ...
          <motion.div initial={{ opacity: 0, x: 30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true, margin: "-50px" }} transition={{ duration: 0.6 }} className="lg:col-span-2 space-y-6">
            <div className="rounded-2xl p-6 sm:p-8 bg-white/[0.03] border border-white/[0.06]">
              ...
              <div className="space-y-4">
                <a href="https://wa.me/5491166781921?text=Hola%20Javier%2C%20me%20interesa%20una%20consulta" target="_blank" rel="noopener noreferrer"
                ...
                <a href="https://instagram.com/javiermendieta.restaurantes" target="_blank" rel="noopener noreferrer"
                ...
                >
                  ...
                  <div><p className="text-white font-semibold text-sm">Instagram</p><p className="text-white/40 text-sm">@javiermendieta.restaurantes</p></div>
                </a>
