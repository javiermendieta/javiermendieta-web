...
const faqs = [
  ...
  { question: "¿Qué incluye la consultoría gastronómica?", answer: "Incluye un diagnóstico completo, un plan estratégico a medida, implementación gradual de mejoras y seguimiento continuo. Trabajo sobre estructura de costos, menú, operación, personal, delivery, gestión comercial y todo lo que impacte en la rentabilidad. Cada consultoría la diseño según las necesidades reales de tu negocio." },
  { question: "¿Cómo medís los resultados?", answer: "Trabajo con métricas concretas: mayor facturación, más clientes, reducción de costos operativos, mejora en tiempos de servicio, incremento en ticket promedio, mejor calificación en plataformas de delivery, disminución de mermas. Al inicio establecemos KPIs claros y los monitoreo durante todo el proceso." },
